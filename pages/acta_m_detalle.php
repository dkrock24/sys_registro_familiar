...
$id_acta =  $_GET['id'];	
$data = selectDetalle($id_acta);
$marginacion = selectMarginacionActa($id_acta);
$logo = logo($pages);
$empresa = empresa();
...
while($row = mysql_fetch_array($id_cargo)){
	$id =  $row['id_rol'];
}
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#id_delete_acta").click(function()
        {
        	var id = $("#id_actaM").val();  
        	var accion="deleteActa";
        	var data = {accion:accion,id:id};

        	deleteActa(data);      	

        });
        function deleteActa(data){
        	$.ajax({
        ...
        $("#marginar_acta").click(function(){        
            var id = $("#id_partida").val();                
           $(".includ").load("pages/acta_marginacion.php?id="+<?php echo $id_acta; ?>);
        });
...
<div class="row">
	...
	<div class="col-md-11" id="">
		...
		<a href="#" id="marginar_acta" class="btn btn-primary">Marginar</a>
		...
		if($id==1){
			?>
				<a href="#" id="id_delete_acta" class="btn btn-warning">Eliminar</a>
			<?php
		}
		?>
...
<div class="row">
	...
	<span class='encabezado'>
		...
		<?php
			...
			{
				?>
					<p><?php echo $row['texto_marginacion']  ?></p>				
				<?php
			}
		?>
			<br>	
...
-->
	...
	<div class="row">
		...
		<div class="col-md-10">
			<table class="firmas">
				<tr>
					<td class="firmas1" contentEditable="true">
						F____________________________ <br>											
						<?php echo $data['alcalde']; ?><br>						
						Alcalde Municipal.
					</td>
					<td class="firmas2" contentEditable="true">
						F____________________________ <br>
